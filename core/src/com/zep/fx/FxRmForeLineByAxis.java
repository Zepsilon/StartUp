...
public class FxRmForeLineByAxis implements FxRemove {

	private Vector2 speed;
	private boolean	animType; // remove: true, add: false

	public FxRmForeLineByAxis() {
		animType = true;
	...
	public void draw(SpriteBatch sb, Kare kare, int i, int j, int dw, int dh, int x, int y) {
		sb.draw(ImageLoader.txtrRegBtn[kare.color()], x + i * dw, y + j * dh, kare.width(), kare.height());
	}
